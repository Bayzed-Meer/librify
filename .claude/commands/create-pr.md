...
allowed-tools: Bash(git status:*), Bash(git diff:*), Bash(git log:*), Bash(git push:*), Bash(git branch:*), Bash(git fetch:*), Bash(gh pr:*), Bash(gh repo:*), Bash(npm run:*), Bash(ng build:*)
---
...
- **NgRx**: note any store changes (actions / reducer / effects / selectors)
